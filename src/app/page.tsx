        ...
        <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:items-center">
          <div className="mx-auto text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <a className="block w-full rounded bg-white border shadow-lg px-12 py-3 text-sm font-medium text-black hover:bg-gray-50 focus:outline-none focus:ring-none sm:w-auto" href="/">
                Get Started
              </a>
            </div>
          </div>
